...
export default function WorkHeader() {
  ...
  return (
    <div
      ref={ref}
      className="text-8xl text-white sticky top-0 items-center w-full flex justify-center overflow-x-hidden h-[100vh]"
    >
      <div className="w-[480px] h-[300px] max-h-[300px] absolute rounded-[24px] overflow-clip">
        <img
          src="galaxy.jpg"
          alt="miracle ui"
      ...
      <motion.svg
        ...
        className="fill-white w-[720px] mix-blend-difference mt-5 z-[50]"
        style={{ scale }}
      >
      ...
      <div className="background-orange">a</div>
    </div>
  );
}
